...
* The 2D array of `supportVector` of size `nSupports x nFeatures`. This is the namesake of the SVM algorithm. This should be gathered from offline training, generated by the [`Python file`](../scripts/pca_svm/svm_reference.py)
